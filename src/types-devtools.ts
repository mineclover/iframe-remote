...
export interface SelectParamMeta extends ParamMetaBase {
  type: 'select'
  /** Available options */
  options: string[] | number[] | { label: string; value: string | number | boolean }[]
}
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function withMeta<T extends (...args: any[]) => any>(fn: T, meta: FunctionMeta): FunctionWithMeta<T> {
